...
def main():
    ...
    parser = argparse.ArgumentParser(description='YCSB Benchmark Flask Server for Obsidian')
    ...
    print(f"Starting YCSB Benchmark Server on {args.host}:{args.port}")
    print(f"Health check: GET http://{args.host}:{args.port}/health")
    print(f"Benchmark status: GET http://{args.host}:{args.port}/status")
    print(f"Single benchmark endpoint: POST http://{args.host}:{args.port}/benchmark")
    print(f"Batch benchmarks endpoint: POST http://{args.host}:{args.port}/benchmarks")
